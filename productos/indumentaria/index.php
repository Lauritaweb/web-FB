...
<head>
    ...
    <title>Indumentaria ciclista | Forever Bikes</title>
    <meta name="description" content="Encontrá la indumentaria Forever para rodar con estilo.">
...
<body class="bg-white">
    <?php include('../../nav.php'); ?>
    <!-- Page Header Start -->
    <header class="container-fluid header bg-seven mb-5 mt-5">
