...
$cartModel->updatePaymentStatus($uuid, 1); // Actualizo el estado de la orden a pagado

$orden = $cartModel->getOrdenCompleta($uuid);

$cliente = $orden['cliente'];
$cart  = $orden['cart'];

$total = 0; // ToDo: recuperar el total

// Recien aca envio el mail de compra
if ($cart != null){   
    Utils::mailSenderPurchase($cliente,$cart, $total); 
    Utils::mailSenderPurchaseLau($cliente,$cart, $total);
}
